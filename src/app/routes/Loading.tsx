...
export const Loading = () => {
  return (
    <div style={divStyles}>
      <h3 style={{ margin: '0 0 16px 0', fontSize: '16px', color: fill }}>Loading...</h3>
      <svg width="38" height="38" style={{ width: '40px', height: '40px'}} viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg">
            <defs>
